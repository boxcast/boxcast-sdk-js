...
/*#__PURE__*/
function () {
  function AuthBroadcastRoutes(headers) {
  ...
  _createClass(AuthBroadcastRoutes, [{
    ...
    value: function list() {
      ...
      return axios.get("".concat(_config.API_ROOT, "/broadcasts"), headers).then(_utils.parseList);
    }
  }, {
    key: "get",
    value: function get(broadcastId) {
      ...
      return axios.get("".concat(_config.API_ROOT, "/broadcasts/").concat(broadcastId), this.headers).then(function (r) {
        return r.data;
      });
    }
  }]);
...
/*#__PURE__*/
function () {
  function AuthChannelRoutes(headers) {
  ...
  _createClass(AuthChannelRoutes, [{
    ...
    value: function list() {
      ...
      return axios.get("".concat(_config.API_ROOT, "/account/channels"), headers).then(_utils.parseList);
    }
  }, {
    key: "get",
    value: function get(channelId) {
      if (!channelId) {
        return Promise.reject('channelId is required');
      }

      return axios.get("".concat(_config.API_ROOT, "/channels/").concat(channelId), this.headers).then(function (r) {
        return r.data;
      });
    }
  }]);
