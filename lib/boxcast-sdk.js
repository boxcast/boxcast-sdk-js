  ...
  _createClass(ChromecastAnalytics, [{
    ...
    value: function attach(params) {
      ...
      var playerManager = params.playerManager,
          castOptions = params.castOptions;
      if (!playerManager) throw Error('playerManager is required');
      if (!castOptions) throw Error('castOptions is required');
      this.playerManager = playerManager;
      this.castOptions = castOptions; // The custom receiver doesn't have a good way to figure out which account ID,
      // broadcast ID, channel ID, etc. are in use. They are passed to us via the
      // customData of the load request.

      this.playerManager.setMediaPlaybackInfoHandler(function (loadRequest, playbackConfig) {
        if (loadRequest.media.customData && loadRequest.media.customData.type && loadRequest.media.customData.type === 'BOXCAST_METADATA') {
          _this.broadcastInfo = loadRequest.media.customData.data;
        }

        return playbackConfig;
      });
      var playbackConfig = Object.assign(new this.framework.PlaybackConfig(), this.playerManager.getPlaybackConfig());

      playbackConfig.segmentRequestHandler = function (requestInfo) {
        return _this._handleSegmentRequest(requestInfo);
      };
    ...
    value: function _wireEvents(v) {
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.ERROR, function (event) {
        _this2._handlePlaybackError(event);
      });
    ...
    key: "_handleSegmentRequest",
    value: function _handleSegmentRequest(requestInfo) {
...
var analytics = {
  ...
  getState: function getState() {
    var browserState = {
      ...
      player_version: "boxcast-sdk-js v".concat("1.0.0")
    };
...
var api = {
  broadcasts: {
    list: function list(channelId) {
      ...
      return axios.get("".concat(API_ROOT, "/channels/").concat(channelId, "/broadcasts"), {
        params: params
      }).then(parseList);
    },
    get: function get(broadcastId) {
      ...
      return axios.get("".concat(API_ROOT, "/broadcasts/").concat(broadcastId)).then(function (response) {
  ...
  channels: {
    list: function list(accountId) {
      ...
      return axios.get("".concat(API_ROOT, "/accounts/").concat(accountId, "/channels"), {
        params: params
      }).then(parseList);
    }
  },
  views: {
    get: function get(broadcastId) {
      ...
      return axios.get("".concat(API_ROOT, "/broadcasts/").concat(broadcastId, "/view"), {
        params: params
