  ...
  _createClass(Html5VideoAnalytics, [{
    ...
    value: function _wireEvents(v) {
      ...
      v.addEventListener('error', function () {
        _this._handlePlaybackError(_this.player.error);
      }, true);
      ...
      v.addEventListener('seeking', function () {
        ...
        _this._report('seek', {
          offset: _this.player.currentTime
        });
      }, true);
    ...
    value: function _handleBufferingStart() {
      ...
      this._waitForBufferingCheck = setTimeout(function () {
        _this2._waitForBufferingCheck = null;

        if (!_this2.isBuffering) {
          return;
        }

        if (_this2._isActuallyPlaying()) {
          _this2._handleBufferingEnd();

          return;
        }

        _this2._report('buffer');
      }, 500);
    }
  }, {
  ...
  _createClass(VideoJsAnalytics, [{
    ...
    value: function _wireEvents(v) {
      ...
      v.on('error', function (err) {
        _this._handlePlaybackError(err);
      });
      v.on('pause', function () {
        _this._handleNormalOperation();
