...
var AUTH_ROOT = 'https://auth.boxcast.com'; // Global state
...
function authHeaders() {
  return {
    headers: {
      'Authorization': "Bearer ".concat(STATE.lastAuthToken)
    }
  };
}
...
var api = {
  ...
  auth: {
    ...
    authenticate: function authenticate(clientId, clientSecret) {
      return axios({
        method: 'post',
        url: "".concat(AUTH_ROOT, "/oauth2/token"),
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: qs.stringify({
    ...
    account: function account() {
      ...
      return axios.get("".concat(API_ROOT, "/account"), authHeaders()).then(function (response) {
        return response.data;
      });
    }
  }
