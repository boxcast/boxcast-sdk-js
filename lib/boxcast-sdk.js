...
/* eslint camelcase: 0 */
var Html5VideoAnalytics = __webpack_require__(/*! ./html5 */ "./src/analytics/html5.js");

var DVR_WINDOW_S = 30;

var ChromecastAnalytics = /*#__PURE__*/function (_Html5VideoAnalytics) {
  _inherits(ChromecastAnalytics, _Html5VideoAnalytics);

  function ChromecastAnalytics() {
    _classCallCheck(this, ChromecastAnalytics);

    return _possibleConstructorReturn(this, (ChromecastAnalytics.__proto__ || Object.getPrototypeOf(ChromecastAnalytics)).apply(this, arguments));
  }

  _createClass(ChromecastAnalytics, [{
    key: "attach",
    value: function attach(params) {
      var playerManager = params.playerManager,
    ...
    key: "handleSegmentRequest",
    value: function handleSegmentRequest(requestInfo) {
      // Set the current level height to whatever level we're most recently requesting.
      if (!requestInfo.url) return;
      var m = requestInfo.url.match(/\/(\d+)p\/\d+\.ts/);
      if (!m || !m[1]) return;
    ...
    value: function _wireEvents() {
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.ENDED, function (event) {
        _this._handleNormalOperation();

        _this._report('complete');

        _this._handleBufferingEnd();
      });
      this.playerManager.addEventListener(this.framework.events.EventType.MEDIA_FINISHED, function (event) {
        _this._handleNormalOperation();
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.ERROR, function (event) {
        _this._handleChromecastError(event);
      });
      this.playerManager.addEventListener(this.framework.events.EventType.PAUSE, function (event) {
        _this._handleNormalOperation();
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.PLAYING, function (event) {
        _this._handleNormalOperation();
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.REQUEST_STOP, function (event) {
        _this._handleNormalOperation();
      ...
      this.playerManager.addEventListener(this.framework.events.EventType.SEEKED, function (event) {
        _this._handleNormalOperation();

        _this._handleBufferingEnd();
      });
      this.playerManager.addEventListener(this.framework.events.EventType.SEEKING, function (event) {
        if (event && event.currentMediaTime) {
          _this._handleNormalOperation();

          _this._report('seek', {
            offset: event.currentMediaTime
          });
        }
      });
      this.playerManager.addEventListener(this.framework.events.EventType.TIME_UPDATE, function (event) {
        if (event.currentMediaTime && _this.lastTimeUpdateTime && event.currentMediaTime !== _this.lastTimeUpdateTime) {
          _this._handleNormalOperation();

          _this._handleBufferingEnd();
        }

        _this.lastTimeUpdateTime = event.currentMediaTime;

        _this._reportTime();
      });
      this.playerManager.addEventListener(this.framework.events.EventType.BUFFERING, function (event) {
        if (event.isBuffering) {
          _this._handleBufferingStart();
        } else {
          _this._handleNormalOperation();
    ...
    key: "_handleChromecastError",
    value: function _handleChromecastError(event) {
      if (this.stoppedHACK) {
        ...
        this._report('error', Object.assign({}, this.browserState, {
    ...
    key: "_getCurrentLevelHeight",
    value: function _getCurrentLevelHeight() {
      return this.currentLevelHeight;
    }
  }, {
    key: "_getDvrIsUse",
    value: function _getDvrIsUse() {
      var liveSeekableRange = this.playerManager.getLiveSeekableRange();
    ...
    key: "framework",
    get: function get() {
      var cast = window.cast || __webpack_require__.g.cast;
      return cast.framework;
    }
  }]);

  return ChromecastAnalytics;
}(Html5VideoAnalytics);

exports.default = ChromecastAnalytics;
module.exports = exports.default;

/***/ }),

/***/ "./src/analytics/html5.js":
/*!********************************!*\
  !*** ./src/analytics/html5.js ***!
  \********************************/
/***/ ((module, exports, __webpack_require__) => {
...
var _require = __webpack_require__(/*! ../utils */ "./src/utils/index.js"),
    uuid = _require.uuid,
    normalizeError = _require.normalizeError,
    normalizeAxiosError = _require.normalizeAxiosError,
    getStorage = _require.getStorage,
    cleanQuotesFromViewerID = _require.cleanQuotesFromViewerID,
    Clock = _require.Clock,
    MonotonicClock = _require.MonotonicClock;

var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

var METRICS_URL = 'https://metrics.boxcast.com/player/interaction';
var PLAYING_STATES = 'play'.split(' ');
var STOPPED_STATES = 'pause buffer idle stop complete error'.split(' ');
var TIME_REPORT_INTERVAL_MS = 60000;
var storage = getStorage();

var Html5VideoAnalytics = /*#__PURE__*/function () {
  function Html5VideoAnalytics(state) {
    _classCallCheck(this, Html5VideoAnalytics);
  ...
  _createClass(Html5VideoAnalytics, [{
    key: "attach",
    value: function attach(params) {
      ...
      if (!broadcast) throw Error('broadcast is required'); // Check if we're already attached and reset if so
    ...
    value: function detach() {
      ...
      Object.keys(this.listeners).forEach(function (evtName) {
        _this.player.removeEventListener(evtName, _this.listeners[evtName], true);
      });
      this.listeners = {}; // Clear up other state
    ...
    key: "_wireEvents",
    value: function _wireEvents(v) {
      var _this2 = this;

      var listeners = {
        'ended': function ended() {
          _this2._handleNormalOperation();

          _this2._report('complete');

          _this2._handleBufferingEnd();
        },
        'error': function error() {
          _this2._handlePlaybackError(_this2.player.error);
        },
        'pause': function pause() {
          _this2._handleNormalOperation();

          _this2._report('pause');
        ...
        'seeking': function seeking() {
          ...
          _this2._report('seek', {
            offset: _this2.player.currentTime
          });
        },
        ...
        'stalled': function stalled() {
          _this2._handleBufferingStart();
        },
        'waiting': function waiting() {
          _this2._handleBufferingStart();
        }
      };
      Object.keys(listeners).forEach(function (evtName) {
        v.addEventListener(evtName, listeners[evtName], true);
      });
      return listeners;
    }
  }, {
    key: "_isActuallyPlaying",
    value: function _isActuallyPlaying() {
    ...
    key: "_handleBufferingStart",
    value: function _handleBufferingStart() {
      var _this3 = this;

      this.isBuffering = true;
      this.lastBufferStart = this.lastBufferStart || MonotonicClock.now(); // Make sure it *stays* buffering for at least 500ms before reporting

      if (this._waitForBufferingCheck) {
        return;
      }

      this._waitForBufferingCheck = setTimeout(function () {
        _this3._waitForBufferingCheck = null;

        if (!_this3.isBuffering) {
          return;
        }

        if (_this3._isActuallyPlaying()) {
          _this3._handleBufferingEnd();

          return;
        }

        _this3._report('buffer');
      }, 500);
    }
  }, {
    key: "_handleNormalOperation",
    value: function _handleNormalOperation() {
      this.stoppedHACK = false;
    }
  }, {
    key: "_handleBufferingEnd",
    value: function _handleBufferingEnd() {
      this.isBuffering = false;
      this.lastBufferStart = null;
      clearTimeout(this._waitForBufferingCheck);
      this._waitForBufferingCheck = null; // When done buffering, accumulate the time since it started buffering and
    ...
    key: "_handlePlaybackError",
    value: function _handlePlaybackError(error) {
      if (this.stoppedHACK) {
        ...
        this._report('error', Object.assign({}, this.browserState, {
          error_object: normalizeError(error)
        }));
      }
    }
  }, {
    ...
    key: "_report",
    value: function _report(action, options) {
      if (!this.isSetup) {
        this._setup();
    ...
    value: function _dequeue() {
      ...
      this._queue.forEach(function (options) {
        axios.post(METRICS_URL, options).catch(function (error) {
  ...
  return Html5VideoAnalytics;
}();

exports.default = Html5VideoAnalytics;
module.exports = exports.default;
...
var Html5VideoAnalytics = __webpack_require__(/*! ./html5.js */ "./src/analytics/html5.js");

var VideoJsAnalytics = __webpack_require__(/*! ./videojs.js */ "./src/analytics/videojs.js");

var ChromecastAnalytics = __webpack_require__(/*! ./chromecast.js */ "./src/analytics/chromecast.js");

var ReactNativeVideoAnalytics = __webpack_require__(/*! ./react-native-video.js */ "./src/analytics/react-native-video.js");
...
var analytics = {
  ...
  getState: function getState() {
    var browserState = {
      ...
      player_version: "boxcast-sdk-js v".concat("1.5.2")
    };
  ...
  mode: function mode(_mode) {
    ...
    throw Error("Mode ".concat(_mode, " not supported"));
  }
};
...
/***/ "./src/analytics/react-native-video.js":
/*!*********************************************!*\
  !*** ./src/analytics/react-native-video.js ***!
  \*********************************************/
/***/ ((module, exports, __webpack_require__) => {
...
var METRICS_URL = 'https://metrics.boxcast.com/player/interaction';
var PLAYING_STATES = 'play'.split(' ');
var STOPPED_STATES = 'pause buffer complete error'.split(' ');
var DOUBLE_REPORT_DEBOUNCE_MIN_MS = 1000;
var TIME_REPORT_INTERVAL_MS = 60000;
var BUFFERING_MIN_TIME_TO_REPORT_MS = 1000;

var ReactNativeVideoAnalytics = /*#__PURE__*/function () {
  function ReactNativeVideoAnalytics(state) {
    _classCallCheck(this, ReactNativeVideoAnalytics);

    this.browserState = state;
    this._queue = [];
  }

  _createClass(ReactNativeVideoAnalytics, [{
    key: "attach",
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(params) {
        var broadcast, channel_id, AsyncStorage, debug;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                broadcast = params.broadcast, channel_id = params.channel_id, AsyncStorage = params.AsyncStorage, debug = params.debug;
    ...
    key: "generateVideoEventProps",
    value: function generateVideoEventProps() {
      return {
    ...
    value: function _onPlaybackRateChange(evt) {
    ...
    value: function _handleBufferingStart() {
      ...
      if (this._bufferTimeoutHandle == null) {
        ...
        this._bufferTimeoutHandle = setTimeout(function () {
          _this.isBuffering && _this._report('buffer');
    ...
    value: function _handleBufferingEnd() {
      this.isBuffering = false;
      this.lastBufferStart = null; // When done buffering, accumulate the time since it started buffering and
      // reset the active buffering timer.
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.storage.getItem('boxcast-viewer-id');

              case 2:
                viewerId = _context2.sent;
      ...
      function _initViewerID() {
        return _ref2.apply(this, arguments);
      }

      return _initViewerID;
    }()
  }, {
    key: "_reportTime",
    value: function _reportTime() {
    ...
    value: function _report(action, options) {
      ...
      this.isPlaying = PLAYING_STATES.indexOf(action) >= 0 || this.isPlaying && !(STOPPED_STATES.indexOf(action) >= 0); // Debounce if triggering same report again (often happens with multiple "play"s during buffering)

      if (action === this.lastAction && n - (this.lastReportAt || n) < DOUBLE_REPORT_DEBOUNCE_MIN_MS) {
        this.debug && console.log("[analytics] Ignoring ".concat(action, " due to debounce on last report"));
        return;
      }
      ...
      options.position = this._getCurrentTime();
      options.duration = Math.round(this.durationPlaying / 1000);
      options.duration_buffering = Math.round((this.totalDurationBuffering + this.activeBufferingDuration) / 1000); // options.videoHeight = // XXX: TODO: figure out how to determine video height
    ...
    value: function _dequeue() {
      ...
      this._queue.forEach(function (options) {
        axios.post(METRICS_URL, options).then(function () {
          _this2.debug && console.log('[analytics] Posted: ', options);
  ...
  return ReactNativeVideoAnalytics;
}();

exports.default = ReactNativeVideoAnalytics;
module.exports = exports.default;

/***/ }),

/***/ "./src/analytics/videojs.js":
/*!**********************************!*\
  !*** ./src/analytics/videojs.js ***!
  \**********************************/
/***/ ((module, exports, __webpack_require__) => {
...
var VideoJsAnalytics = /*#__PURE__*/function (_Html5VideoAnalytics) {
  _inherits(VideoJsAnalytics, _Html5VideoAnalytics);

  function VideoJsAnalytics() {
    _classCallCheck(this, VideoJsAnalytics);

    return _possibleConstructorReturn(this, (VideoJsAnalytics.__proto__ || Object.getPrototypeOf(VideoJsAnalytics)).apply(this, arguments));
  }

  _createClass(VideoJsAnalytics, [{
    key: "attach",
    value: function attach(params) {
    ...
    value: function detach() {
      ...
      // Remove video event listeners
      Object.keys(this.listeners).forEach(function (evtName) {
        _this.player.off(evtName, _this.listeners[evtName]);
      });
      this.listeners = {}; // Clear up other state
    ...
    value: function _wireEvents(v) {
      ...
      var listeners = {
        ...
        'error': function error(err) {
          _this2._handlePlaybackError(err);
        },
        'pause': function pause() {
          _this2._handleNormalOperation();
  ...
  return VideoJsAnalytics;
}(Html5VideoAnalytics);

exports.default = VideoJsAnalytics;
module.exports = exports.default;

/***/ }),

/***/ "./src/api/auth_broadcast_routes.js":
/*!******************************************!*\
  !*** ./src/api/auth_broadcast_routes.js ***!
  \******************************************/
/***/ ((module, exports, __webpack_require__) => {
...
var _base_route = __webpack_require__(/*! ./base_route */ "./src/api/base_route.js");
...
var AuthBroadcastRoutes = /*#__PURE__*/function (_BaseAuthenticatedRou) {
  _inherits(AuthBroadcastRoutes, _BaseAuthenticatedRou);

  function AuthBroadcastRoutes() {
    _classCallCheck(this, AuthBroadcastRoutes);

    return _possibleConstructorReturn(this, (AuthBroadcastRoutes.__proto__ || Object.getPrototypeOf(AuthBroadcastRoutes)).apply(this, arguments));
  }

  _createClass(AuthBroadcastRoutes, [{
    key: "resourceBase",
    get: function get() {
      return 'broadcasts';
    }
  ...
  return AuthBroadcastRoutes;
}(_base_route.BaseAuthenticatedRoute);

exports.default = AuthBroadcastRoutes;
module.exports = exports.default;

/***/ }),

/***/ "./src/api/auth_channel_routes.js":
/*!****************************************!*\
  !*** ./src/api/auth_channel_routes.js ***!
  \****************************************/
/***/ ((module, exports, __webpack_require__) => {
...
var AuthChannelRoutes = /*#__PURE__*/function (_BaseAuthenticatedRou) {
  _inherits(AuthChannelRoutes, _BaseAuthenticatedRou);

  function AuthChannelRoutes() {
    _classCallCheck(this, AuthChannelRoutes);

    return _possibleConstructorReturn(this, (AuthChannelRoutes.__proto__ || Object.getPrototypeOf(AuthChannelRoutes)).apply(this, arguments));
  }

  _createClass(AuthChannelRoutes, [{
    key: "resourceBase",
    get: function get() {
  ...
  return AuthChannelRoutes;
}(_base_route.BaseAuthenticatedRoute);

exports.default = AuthChannelRoutes;
module.exports = exports.default;

/***/ }),

/***/ "./src/api/auth_routes.js":
/*!********************************!*\
  !*** ./src/api/auth_routes.js ***!
  \********************************/
/***/ ((module, exports, __webpack_require__) => {
...
var _auth_broadcast_routes = _interopRequireDefault(__webpack_require__(/*! ./auth_broadcast_routes */ "./src/api/auth_broadcast_routes.js"));

var _auth_channel_routes = _interopRequireDefault(__webpack_require__(/*! ./auth_channel_routes */ "./src/api/auth_channel_routes.js"));
...
var AuthenticatedRoutes = /*#__PURE__*/function () {
  function AuthenticatedRoutes() {
    _classCallCheck(this, AuthenticatedRoutes);
  }

  _createClass(AuthenticatedRoutes, [{
    key: "logout",
    value: function logout() {
      _state.STATE.lastAuthToken = null;
    }
  }, {
    key: "authenticate",
    value: function authenticate(clientId, clientSecret) {
      return axios({
        method: 'post',
        url: "".concat(_config.AUTH_ROOT, "/oauth2/token"),
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: qs.stringify({
        ...
        _state.STATE.lastAuthToken = result.access_token;
        return result;
      });
    }
  }, {
    ...
    value: function account() {
      if (!_state.STATE.lastAuthToken) {
        return Promise.reject('Authentication is required');
      }

      return axios.get("".concat(_config.API_ROOT, "/account"), (0, _utils.authHeaders)()).then(function (r) {
        return r.data;
      });
    }
  }, {
    key: "broadcasts",
    get: function get() {
      return new _auth_broadcast_routes.default((0, _utils.authHeaders)());
    }
  }, {
    key: "channels",
    get: function get() {
      return new _auth_channel_routes.default((0, _utils.authHeaders)());
    }
  }]);
...
exports.BaseAuthenticatedRoute = void 0;
...
var BaseAuthenticatedRoute = /*#__PURE__*/function () {
  _createClass(BaseAuthenticatedRoute, [{
    key: "resourceBase",
    get: function get() {
  ...
  function BaseAuthenticatedRoute(headers) {
    _classCallCheck(this, BaseAuthenticatedRoute);
  ...
  _createClass(BaseAuthenticatedRoute, [{
    ...
    value: function list() {
      ...
      return axios.get("".concat(_config.API_ROOT, "/").concat(this.resourceBase), headers).then(_utils.parseList);
    }
  }, {
    key: "get",
    value: function get(id) {
      ...
      return axios.get("".concat(_config.API_ROOT, "/").concat(this.resourceBase, "/").concat(id), this.headers).then(function (r) {
        return r.data;
      });
    }
  }, {
    ...
    value: function create() {
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return axios.post("".concat(_config.API_ROOT, "/").concat(this.resourceBase), params, this.headers).then(function (r) {
        return r.data;
      });
    }
  }, {
    ...
    value: function update(id) {
      ...
      return axios.put("".concat(_config.API_ROOT, "/").concat(this.resourceBase, "/").concat(id), params, this.headers).then(function (r) {
        return r.data;
      });
    }
  }, {
    ...
    value: function destroy(id) {
      ...
      return axios.delete("".concat(_config.API_ROOT, "/").concat(this.resourceBase, "/").concat(id), this.headers).then(function (r) {
        return r.data;
      });
    }
  }]);

  return BaseAuthenticatedRoute;
}();

exports.BaseAuthenticatedRoute = BaseAuthenticatedRoute;

/***/ }),

/***/ "./src/api/broadcast_routes.js":
/*!*************************************!*\
  !*** ./src/api/broadcast_routes.js ***!
  \*************************************/
/***/ ((module, exports, __webpack_require__) => {
...
var BroadcastRoutes = /*#__PURE__*/function () {
  function BroadcastRoutes() {
    _classCallCheck(this, BroadcastRoutes);
  }

  _createClass(BroadcastRoutes, [{
    key: "list",
    value: function list(channelId) {
      ...
      return axios.get("".concat(_config.API_ROOT, "/channels/").concat(channelId, "/broadcasts"), {
        params: params
      }).then(_utils.parseList);
    }
  }, {
    key: "get",
    value: function get(broadcastId) {
      if (!broadcastId) {
        return Promise.reject('broadcastId is required');
      }

      return axios.get("".concat(_config.API_ROOT, "/broadcasts/").concat(broadcastId)).then(function (r) {
        return r.data;
      });
    }
  }]);
...
exports.default = BroadcastRoutes;
module.exports = exports.default;

/***/ }),

/***/ "./src/api/channel_routes.js":
/*!***********************************!*\
  !*** ./src/api/channel_routes.js ***!
  \***********************************/
/***/ ((module, exports, __webpack_require__) => {
...
var ChannelRoutes = /*#__PURE__*/function () {
  function ChannelRoutes() {
    _classCallCheck(this, ChannelRoutes);
  }

  _createClass(ChannelRoutes, [{
    key: "list",
    value: function list(accountId) {
      ...
      return axios.get("".concat(_config.API_ROOT, "/accounts/").concat(accountId, "/channels"), {
        params: params
      }).then(_utils.parseList);
    }
  }]);
...
var _broadcast_routes = _interopRequireDefault(__webpack_require__(/*! ./broadcast_routes */ "./src/api/broadcast_routes.js"));

var _channel_routes = _interopRequireDefault(__webpack_require__(/*! ./channel_routes */ "./src/api/channel_routes.js"));

var _view_routes = _interopRequireDefault(__webpack_require__(/*! ./view_routes */ "./src/api/view_routes.js"));

var _auth_routes = _interopRequireDefault(__webpack_require__(/*! ./auth_routes */ "./src/api/auth_routes.js"));
...
var api = {
  // Public API Methods
  broadcasts: new _broadcast_routes.default(),
  channels: new _channel_routes.default(),
  views: new _view_routes.default(),
  // Authenticated API Methods
  auth: new _auth_routes.default()
};
var _default = api;
exports.default = _default;
module.exports = exports.default;
...
var ViewRoutes = /*#__PURE__*/function () {
  function ViewRoutes() {
    _classCallCheck(this, ViewRoutes);
  }

  _createClass(ViewRoutes, [{
    key: "get",
    value: function get(broadcastId) {
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      return axios.get("".concat(_config.API_ROOT, "/broadcasts/").concat(broadcastId, "/view"), {
        params: params
      }).then(function (r) {
        return r.data;
      }).then(function (view) {
...
exports.AUTH_ROOT = exports.API_ROOT = void 0;
var API_ROOT = 'https://api.boxcast.com';
exports.API_ROOT = API_ROOT;
var AUTH_ROOT = 'https://auth.boxcast.com';
...
exports.uuid = uuid;
exports.cleanQuotesFromViewerID = cleanQuotesFromViewerID;
exports.normalizeError = normalizeError;
exports.normalizeAxiosError = normalizeAxiosError;
...
Object.defineProperty(exports, "MonotonicClock", ({
  enumerable: true,
  get: function get() {
    return _monotonic_clock.default;
  }
}));

var _clock = _interopRequireDefault(__webpack_require__(/*! ./clock */ "./src/utils/clock.js"));

var _monotonic_clock = _interopRequireDefault(__webpack_require__(/*! ./monotonic_clock */ "./src/utils/monotonic_clock.js"));
...
function normalizeError(error, source) {
  ...
  error = error || {};
  var code = error.code || error.data && error.data.code;
  var message = error.message;

  if (!message && error.data) {
    message = error.data.details
    /* hlsError, cannot be stringified */
...
function authHeaders() {
  return {
    headers: {
      'Authorization': "Bearer ".concat(_state.STATE.lastAuthToken)
    }
  };
}
...
var MonotonicClock = /*#__PURE__*/function () {
  function MonotonicClock() {
    _classCallCheck(this, MonotonicClock);
  }

  _createClass(MonotonicClock, null, [{
    key: "now",
    value: function now() {
      ...
      return _clock.default.now().getTime();
    }
  }]);
...
exports.default = MonotonicClock;
module.exports = exports.default;
...
var _analytics = _interopRequireDefault(__webpack_require__(/*! ./analytics */ "./src/analytics/index.js"));
...
//# sourceMappingURL=boxcast-sdk.js.map