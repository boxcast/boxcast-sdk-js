...
function () {
  ...
  _createClass(Html5VideoAnalytics, [{
    ...
    value: function _report(action, options) {
      ...
      var n = new Date(); // Accumulate the playing/buffering counters
...
function () {
  ...
  _createClass(ReactNativeVideoAnalytics, [{
    ...
    value: function _report(action, options) {
      ...
      options.position = this._getCurrentTime();
      options.duration = Math.round(this.durationPlaying / 1000);
      options.duration_buffering = Math.round(this.durationBuffering / 1000); // options.videoHeight = // XXX: TODO: figure out how to determine video height
