(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("boxcast-sdk", [], factory);
	else if(typeof exports === 'object')
		exports["boxcast-sdk"] = factory();
	else
		root["boxcast-sdk"] = factory();
})(window, function() {
...
function () {
  ...
  _createClass(Html5VideoAnalytics, [{
    ...
    value: function _report(action, options) {
      ...
      options.duration_buffering = Math.round(this.durationBuffering / 1000); // TODO: consider a more appropriate way to get level height, e.g. if using hls.js
...
var api = {
  broadcasts: {
    list: function list(channelId, params) {
  ...
  channels: {
    list: function list(accountId, params) {
  ...
  views: {
    get: function get(broadcastId, params) {
