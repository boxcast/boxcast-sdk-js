...
function () {
  ...
  _createClass(AuthenticatedRoutes, [{
    ...
    value: function account() {
      ...
      return axios.get("".concat(_config.API_ROOT, "/account"), authHeaders()).then(function (r) {
        return r.data;
      });
    }
  }, {
    key: "broadcasts",
    get: function get() {// TODO: return authenticated broadcast resources
    }
  }, {
    key: "channels",
    get: function get() {// TODO: return authenticated channel resources
    }
  }]);
